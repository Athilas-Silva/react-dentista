            ...
            <div className="home-apresentacao">
                ...
                <ul className="lista-sobre-aparelho limitar-container">
                    ...
                    <li>
                        ...
                        <p>Muitas pessoas nem conseguem usar fio dental devido à posição da sua dentição. Contudo, a correção possibilita o cuidado com a saúde bucal de forma bem mais ampla</p>
                    </li>

                    <li>
                        <h3>Corrigir espaço entre os dentes</h3>
                        <p>Uma dentição desalinhada e com espaços significativos incomodam muitas pessoas. Usar aparelho nos dentes é uma das formas mias eficientes para que esses problemas possam ser corrigidos</p>
                    </li>
                </ul>
                ...
                <div className="home-depoimentos">
                    ...
                    <ul className="lista-depoimentos">
                        ...
                        <li>
                            ...
                            <p>Carla Souza</p>
                            <p>Comecei a usar no ano passado e já estou notando a diferença</p>
                        </li>
                    </ul>
                </div>
